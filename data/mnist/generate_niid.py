...
mnist = fetch_openml('mnist_784', version=1, cache=True, data_home='./data', as_frame=False)
...
user = 0
props = np.random.lognormal(0, 2.0, (10, NUM_USERS, NUM_LABELS))  # last 5 is 5 labels
print(f"props = {props}")
...
print("idx_powerlaw:", idx) # counting samples for each labels
