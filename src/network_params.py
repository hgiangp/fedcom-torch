...
epsilon_0 = 1e-2 # global accuracy 

compression_ratio = 0.1 # 1-0.95
s_n = 50240 # 502400*compression_ratio=25120 bits # data transmission size TODO (784 * 10 + 10) * 2 * 32 = 502400 bits 
bw_dB = 60 # 1MHz bandwidth
bw = to_times(bw_dB)

delta_t = 0.0005 # TODO Based on current results uav's time penalty 0.5ms
N_0 = to_times(-174+bw_dB-30) # -174 dBm?/Hz, noise density, should be multiplied with bw: 1e(-17.4)*1e6 = 4*1e(-12) (4*1e-15?)
